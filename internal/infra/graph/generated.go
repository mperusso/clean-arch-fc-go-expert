...
type ComplexityRoot struct {
	Mutation struct {
		...
		ListOrders  func(childComplexity int, input *model.OrderInput) int
	}
...
type MutationResolver interface {
	...
	ListOrders(ctx context.Context, input *model.OrderInput) ([]*model.Order, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.listOrders":
		if e.complexity.Mutation.ListOrders == nil {
			break
		}

		args, err := ec.field_Mutation_listOrders_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.ListOrders(childComplexity, args["input"].(*model.OrderInput)), true
...
func (ec *executionContext) field_Mutation_listOrders_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_listOrders_argsInput(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_listOrders_argsInput(
	ctx context.Context,
	rawArgs map[string]any,
) (*model.OrderInput, error) {
	if _, ok := rawArgs["input"]; !ok {
...
func (ec *executionContext) _Mutation_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_listOrders(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().ListOrders(rctx, fc.Args["input"].(*model.OrderInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_listOrders(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_listOrders_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "listOrders":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_listOrders(ctx, field)
			})
		default:
